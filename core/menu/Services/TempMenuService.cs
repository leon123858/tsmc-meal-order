...
{
    public class TempMenuService: IMenuService
    {
        private readonly IMongoCollection<Menu> _menus;
        private string _connectionString;

        public TempMenuService(IOptions<MenuDatabaseConfig> databaseSettings)
        {
            ...
            _menus = mongoDatabase.GetCollection<Menu>(databaseSettings.Value.TempCollectionName);
        }
